...
import { SELECT_CLIENT_COLUMNS } from '../SelectClientTable/SelectClientColumn';

import { GlobalFilter } from '../Filters/GlobalFilter'

import axios from 'axios';

function SelectClientTable(props) {

	const [columnData, setColumnData] = useState([])
	let selectedRowInput = document.getElementById('selected-client-json')
	...
	const columns = useMemo(() => SELECT_CLIENT_COLUMNS, [])
		...
		<div>
			<div className="cs-table-top">
				<div className="cs-select-show-number form-group form-inline">
					...
					<span className="pl-2" >klijenata</span>
				</div>
...
RenderComponent(SelectClientTable, 'modal-clients-table')
